...
class OverviewActivity : AppCompatActivity(){
    ...
    //FIXED: lateinit var toggle: ActionBarDrawerToggle
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*FIXED: setSupportActionBar(overview_toolbar)
        ...
        //FIXED: supportActionBar?.elevation = 0F //To remove the shadow beneath the activity toolbar

        rv_overview.setHasFixedSize(true)

        /**Functionality to configure the drawer layout and Navigation view*/
        /*FIXED: val drawerLayout : DrawerLayout = findViewById(R.id.nav_drawer_layout)
